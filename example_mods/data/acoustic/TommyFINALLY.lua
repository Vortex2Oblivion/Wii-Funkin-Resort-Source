...
idle_xml_name = 'tommy idle'
left_xml_name = 'tommy left'
down_xml_name = 'tommy down'
up_xml_name = 'tommy up'
right_xml_name = 'tommy right'
...
name_of_character_xml = 'TOMMYSHADED'
name_of_character = 'tommy'
name_of_notetype = 'Tommy'
name_of_notetype2 = 'TommyMatt'
