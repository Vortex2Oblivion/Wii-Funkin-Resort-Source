...
idleoffsets = {'-5', '20'} -- I recommend you have your idle offset at 0
leftoffsets = {'55', '4'}
downoffsets = {'14', '-12'}
upoffsets = {'-5', '40'}
rightoffsets = {'-16', '5'}
...
idle_xml_name = 'BFWiiIdle'
left_xml_name = 'BFWiiLeft'
down_xml_name = 'BFWiiDown'
up_xml_name = 'BFWiiUp'
right_xml_name = 'BFWiiRight'
...
name_of_character_xml = 'BoyfriendWii'
name_of_character = 'bfbasketball'
name_of_notetype = 'BF'
name_of_notetype2 = 'GFBF'
name_of_notetype3 = 'BFPico'
