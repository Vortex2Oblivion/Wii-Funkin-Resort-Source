--stage
function onCreate()
	makeLuaSprite('sky','newsword/sky', -850, -500)
	addLuaSprite('sky')
	setScrollFactor('sky', 0.0, 0.0)

	makeLuaSprite('islandbridge','newsword/islandbridge', 0, 0)
	addLuaSprite('islandbridge')
	setScrollFactor('islandbridge', 0.3, 0.3)

	makeLuaSprite('buildings','newsword/buildings', 300, 0)
	addLuaSprite('buildings')
	setScrollFactor('buildings', 0.5, 0.5)

	makeLuaSprite('bigscreen','newsword/bigscreen', 275, 250)
	addLuaSprite('bigscreen')
	setScrollFactor('bigscreen', 0.84, 0.84)

	makeAnimatedLuaSprite('invalid_speakers','newsword/invalid_speakers', 350, 550)
	...
	makeAnimatedLuaSprite('boppers','newsword/boppers', -510, 170 * 1.5)
	...
	makeLuaSprite('platform','newsword/platform', -250, 1000)
	addLuaSprite("platform")

	makeLuaSprite('sunoverlay','newsword/sunoverlay', -500, -500)
