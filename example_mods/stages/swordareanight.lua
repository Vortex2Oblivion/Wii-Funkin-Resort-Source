--stage
function onCreate()
	makeLuaSprite('sky','newsword/night/sky', -850, -500)
	addLuaSprite('sky')
	setScrollFactor('sky', 0.0, 0.0)

	makeLuaSprite('islandbridge','newsword/night/islandbridge', 0, 0)
	addLuaSprite('islandbridge')
	setScrollFactor('islandbridge', 0.3, 0.3)

	makeLuaSprite('buildings','newsword/night/buildings', 300, 0)
	addLuaSprite('buildings')
	setScrollFactor('buildings', 0.5, 0.5)

	makeLuaSprite('bigscreen','newsword/night/bigscreen', 275, 250)
	addLuaSprite('bigscreen')
	setScrollFactor('bigscreen', 0.84, 0.84)

	makeAnimatedLuaSprite('invalid_speakers','newsword/night/invalid_speakers', 350, 550)
	...
	makeAnimatedLuaSprite('boppers','newsword/night/boppers', -510, 170 * 1.5)
	...
	makeLuaSprite('platform','newsword/night/platform', -250, 1000)
	addLuaSprite("platform")

	makeLuaSprite('sunoverlay','newsword/night/sunoverlay', -500, -500)
