 ...
 * @see https://github.com/HaxeFlixel/flixel-demos/blob/dev/Effects/DynamicShadows/source/Shader.hx
 * @author Geokureli
 */
class DynamicLighting extends flixel.system.FlxAssets.FlxShader
{
